...
import { termStopsForProduct, type Currency } from '../loanCalc'
...
// Leading reference glyph shown at the start of each form field.
const fieldIcon = (name: IconName): ReactNode => (
  <Box sx={{ width: 36, height: 36, borderRadius: '10px', bgcolor: '#EEF3FC', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
    <Icon name={name} size={18} color={BLUE} />
  </Box>
)
